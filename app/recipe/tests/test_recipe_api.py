...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_update_recipe_assign_tag(self):
        """Test assigning an exisiting tag when updating a recipe."""
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('6.43'),
            'ingredients': [{'name': 'Cauliflower'}, {'name': 'Potato'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_create_ingredient_on_update(self):
        """Test creating ingredient while updating recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Butter chicken')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Thai vegetable curry')
        r2 = create_recipe(user=self.user, title='Butter chicken')
        ingredient1 = Tag.objects.create(user=self.user, name='vegetables')
        ingredient2 = Tag.objects.create(user=self.user, name='chicken')
